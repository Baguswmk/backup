  ...
  <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
    <div className="text-center max-w-md mx-auto p-6">
      ...
      <p className="text-gray-600 dark:text-gray-400 mb-6">
        There was an error loading the application. This might be due to a
...
const ProtectedRoute = ({ children, requiredRoles = null, appKey = null }) => {
  ...
  if (requiredRoles && !hasRole(...requiredRoles)) {
    console.warn(
      `Role access denied. Required: ${requiredRoles.join(", ")}, User: ${user?.role}`,
    );
    return <Navigate to="/timbangan-internal/hub" replace />;
  }
      ...
      return (
        <Route
          ...
          element={
            ...
            >
              <Suspense
                fallback={<LoadingOverlay message={config.loadingMessage} />}
              >
                <Component />
              </Suspense>
            </ProtectedRoute>
    ...
    <ErrorBoundary>
      <Routes>
        ...
        <Route
          ...
          element={
            <Suspense
              fallback={<LoadingOverlay message="Loading authentication..." />}
            >
              <LoginPage />
            </Suspense>
          }
        ...
        {/* Legacy redirects */}
        <Route
          path="/timbangan-internal/dashboard"
          element={<Navigate to="/timbangan-internal/hub" replace />}
        />
        <Route
          path="/timbangan-internal"
          element={<Navigate to="/timbangan-internal/hub" replace />}
        />
