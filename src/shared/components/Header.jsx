          ...
          <nav className="hidden lg:flex items-center space-x-2">
            {menuItems.map((item) => {
              ...
              const hasAccess =
                ...
                (hasChildren &&
                  item.children.some((child) => checkMenuAccess(child)));
                    ...
                    >
                      {item.children.map((child) => {
                        ...
                        const childAccessible =
                          checkMenuAccess(child) ||
                          (hasGrandchildren &&
                            child.children.some((gc) => checkMenuAccess(gc)));
                            ...
                            <DropdownMenuSub key={child.name}>
                              ...
                              <DropdownMenuSubContent className="w-56 bg-neutral-50 dark:bg-slate-800 border-gray-200 dark:border-slate-700">
                                {child.children.map((grandchild) => {
                                  ...
                                  const grandchildAccessible =
                                    checkMenuAccess(grandchild);
                                  ...
                                  return (
                                    ...
                                    >
                                      {GrandchildIcon && (
                                        <GrandchildIcon className="w-4 h-4 mr-2" />
                                      )}
                        ...
                        {item.children.map((child) => {
                          ...
                          return (
                            <Button
                              ...
                              onClick={() => handleMenuClick(child.name, child)}
                              variant={
                                activeMenu === child.name ? "default" : "ghost"
                              }
                              className={cn(
