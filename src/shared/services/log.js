...
class LogService {
  ...
  // ✅ IMPROVED - More efficient sanitization
  sanitizeData(data) {
  ...
  // ✅ IMPROVED - Use getFirstTruthyValue utility
  getCurrentUserId() {
    try {
      ...
      // Use utility to get first available id field
      return getFirstTruthyValue(parsed, 'id', 'userId', 'user_id') || 'anonymous';
    } catch {
      return 'anonymous';
    }
  }
