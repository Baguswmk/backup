...
import { Truck, RefreshCw, Package, Filter, ChevronDown, ChevronUp } from "lucide-react";
import {
  Table,
  TableBody,
  TableCell,
...
const FleetList = ({
  ...
  return (
    <Card data-fleet-list className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
      <CardHeader className="border-b border-gray-200 dark:border-gray-700">
        <div className="flex items-center justify-between">
          <CardTitle className="flex items-center gap-2 text-gray-900 dark:text-white">
            <Truck className="w-5 h-5" />
            {userRole === USER_ROLES.OPERATOR_JT ? 'Fleet yang Ditugaskan untuk Anda' : 'Daftar Fleet'}
          </CardTitle>
      ...
      <CardContent className="pt-6">
        ...
        {isInitialLoading ? (
          <div className="text-center py-12">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-4">Memuat data fleet...</p>
          </div>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-gray-50 dark:bg-gray-900/50 hover:bg-gray-50 dark:hover:bg-gray-900/50">
                    ...
                    <TableHead className="w-37.5 text-gray-700 dark:text-gray-300 font-semibold">Excavator</TableHead>
                    <TableHead className="text-gray-700 dark:text-gray-300 font-semibold">Company</TableHead>
                    <TableHead className="text-gray-700 dark:text-gray-300 font-semibold">Measurement Type</TableHead>
                    <TableHead className="text-gray-700 dark:text-gray-300 font-semibold">Loading Point</TableHead>
                    <TableHead className="text-gray-700 dark:text-gray-300 font-semibold">Dumping Point</TableHead>
                    <TableHead className="text-right text-gray-700 dark:text-gray-300 font-semibold">Jumlah DT</TableHead>
                    <TableHead className="text-gray-700 dark:text-gray-300 font-semibold">Checker</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                    ...
                    >
                      ...
                      <TableCell>
                        <Badge variant="outline" className="capitalize border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300">
                          {fleet.measurement_type || fleet.measurementType || 'timbangan'}
                        </Badge>
                      </TableCell>
                      <TableCell className="text-gray-700 dark:text-gray-300">
                      ...
                      <TableCell className="text-right">
                        <Badge variant="secondary" className="bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300">
                          {(fleet.dumptruck?.length || fleet.units?.length || 0)} unit
                        </Badge>
                      </TableCell>
                      <TableCell className="text-gray-600 dark:text-gray-400 text-sm">
                        {fleet.checker || fleet.fleet_checker || fleet.checker_name || '-'}
                      </TableCell>
                    </TableRow>
                  ))}
                </TableBody>
