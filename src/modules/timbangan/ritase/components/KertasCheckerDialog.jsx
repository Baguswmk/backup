    ...
    useEffect(() => {
      if (isBulkEditDialogOpen && data) {
        ...
        setBulkEditData({
          ...
          loading_location: firstTrip?.loading_location || data.loading_location || "",
          dumping_location: firstTrip?.dumping_location || data.dumping_location || "",
          measurement_type: firstTrip?.measurement_type || data.measurement_type || "",
        ...
        for (const trip of data.trips) {
          try {
            const updateData = {
              ...
              loading_location: bulkEditData.loading_location || trip.loading_location,
              dumping_location: bulkEditData.dumping_location || trip.dumping_location,
              measurement_type: bulkEditData.measurement_type || trip.measurement_type,
              distance: bulkEditData.distance ? parseInt(bulkEditData.distance) : (trip.distance || 0),
    ...
    return (
      <>
        <Dialog open={isOpen} onOpenChange={onClose}>
          <DialogContent className="min-w-[95vw] sm:min-w-[90vw] md:min-w-[85vw] lg:min-w-[80vw] max-h-[95vh] overflow-x-auto bg-white border-none text-gray-900 dark:bg-slate-900 dark:text-white p-0">
            {/* Header Section */}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 text-xs sm:text-sm print:text-black">
                <div className="space-y-1.5 sm:space-y-2">
                  <div className="flex flex-wrap items-center gap-1 sm:gap-2">
                    <span className="dark:text-slate-400 print:text-gray-700">Shift: </span>
                  ...
                  <div className="flex flex-wrap items-center gap-1 sm:gap-2">
                    <span className="dark:text-slate-400 print:text-gray-700">Excavator: </span>
                    <Badge className="bg-blue-600 text-white text-xs print:bg-white print:text-black print:border print:border-black">
                      {data.excavator}
                    </Badge>
                  </div>
                  <div>
                    <span className="dark:text-slate-400 print:text-gray-700">Loading Point: </span>
                    <span className="font-semibold wrap-break-word print:text-black">{data.loading_location}</span>
                  </div>
                  <div>
                    <span className="dark:text-slate-400 print:text-gray-700">Dumping Point: </span>
                    <span className="font-semibold wrap-break-word print:text-black">{data.dumping_location}</span>
                  </div>
                  <div>
                    <span className="dark:text-slate-400 print:text-gray-700">Jarak: </span>
                    <span className="font-semibold wrap-break-word print:text-black">{data.distance}</span>
                  </div>
                </div>
                <div className="space-y-1.5 sm:space-y-2">
                  <div>
                    <span className="dark:text-slate-400 print:text-gray-700">Jenis Batubara: </span>
                    <span className="font-semibold  print:text-black">{data.coal_type}</span>
                  </div>
                  <div className="flex flex-wrap items-center gap-1 sm:gap-2">
                    <span className="dark:text-slate-400 print:text-gray-700">Measurement Type: </span>
                    <Badge variant="outline" className="capitalize border-slate-600 dark:text-white text-xs print:bg-white print:text-black print:border print:border-black">
                      {data.measurement_type}
                    </Badge>
                  </div>
                  <div>
                    <span className="dark:text-slate-400 print:text-gray-700">Total Ritase: </span>
                    <span className="font-semibold text-blue-400 print:text-black">{data.tripCount} rit</span>
                  </div>
                  <div>
                    <span className="dark:text-slate-400 print:text-gray-700">Total Tonase: </span>
            ...
            <div className="p-3 sm:p-4 md:p-6">
              <div className="print:block">
                <div className="overflow-x-auto border border-slate-700 rounded-lg print:border-black">
                            ...
                            return (
                              ...
                              >
                                {trips.length > 0 ? (
                                      ...
                                      >
                                        ...
                                        <div className="absolute -top-1 -right-1 opacity-0 group-hover:opacity-100 transition-opacity print:hidden">
                                          <DropdownMenu>
                                            ...
                                            <DropdownMenuContent align="end" className="w-32 dark:bg-slate-900 bg-white dark:text-neutral-50 border-none">
                                              <DropdownMenuItem
                                  ...
                                  <span className="dark:text-slate-500 print:text-gray-400">-</span>
                                )}
                              </td>
                            );
                          })}
              ...
              <div className="space-y-4 pt-4">
                ...
                <div className="bg-gray-100 dark:bg-slate-800 rounded-md p-3">
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    <div>
                      <span className="text-gray-500 dark:text-gray-400">Hull No:</span>
                      <p className="font-semibold text-gray-900 dark:text-white">{selectedTrip.hull_no}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-gray-900 dark:text-white">
                        {selectedTrip.weight || selectedTrip.gross_weight || selectedTrip.net_weight} ton
                      </p>
                    </div>
                    <div>
                      <span className="text-gray-500 dark:text-gray-400">Time:</span>
                      <p className="font-semibold text-gray-900 dark:text-white">
                        {format(new Date(selectedTrip.time || selectedTrip.date), "HH:mm")}
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-4">
                    <div className="border-t border-gray-200 dark:border-slate-700 pt-3">
                      <p className="text-sm font-medium text-gray-900 dark:text-white mb-4">
                        Langkah 1: Apakah Anda yakin akan menghapus data ritase ini?
                      </p>
            ...
            <DialogContent className="max-w-2xl bg-slate-900 text-white border border-slate-700">
              <DialogHeader>
                ...
                <p className="text-sm text-slate-400 mt-2">
                  Perubahan akan diterapkan ke semua {data?.trips?.length || 0} data DT dalam kertas checker ini.
              ...
              <div className="space-y-4 py-4">
                ...
                <div>
                  ...
                  <SearchableSelect
                    ...
                    onChange={(value) => setBulkEditData({ ...bulkEditData, shift: value })}
                ...
                <div>
                  ...
                  <SearchableSelect
                    ...
                    onChange={(value) => setBulkEditData({ ...bulkEditData, excavator: value })}
                ...
                <div>
                  ...
                  <SearchableSelect
                    ...
                    onChange={(value) => setBulkEditData({ ...bulkEditData, loading_location: value })}
                ...
                <div>
                  ...
                  <SearchableSelect
                    ...
                    onChange={(value) => setBulkEditData({ ...bulkEditData, dumping_location: value })}
                ...
                <div>
                  ...
                  <SearchableSelect
                    ...
                    onChange={(value) => setBulkEditData({ ...bulkEditData, measurement_type: value })}
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setBulkEditData({ ...bulkEditData, distance: e.target.value })}
