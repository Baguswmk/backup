  ...
  return (
    <>
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="min-w-[95vw] sm:min-w-[90vw] md:min-w-[85vw] lg:min-w-[80vw] max-h-[95vh] overflow-x-auto bg-slate-900 text-white p-0">
          {/* Header Section */}
          <div className="sticky top-0 z-50 bg-slate-800 border-b border-slate-700 p-3 sm:p-4 md:p-6 print:static print:bg-white print:text-black">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 text-xs sm:text-sm print:text-black">
              <div className="space-y-1.5 sm:space-y-2">
                ...
                <div>
                  <span className="text-slate-400 print:text-gray-700">Jarak: </span>
                  <span className="font-semibold wrap-break-word print:text-black">{data.distance}</span>
                </div>
              </div>
              <div className="space-y-1.5 sm:space-y-2">
                <div>
                  <span className="text-slate-400 print:text-gray-700">Jenis Batubara: </span>
                ...
                <table className="w-full text-xs sm:text-sm border-collapse">
                  <thead>
                    <tr className="bg-slate-700">
                      <th className="px-2 sm:px-4 py-2 sm:py-3 text-left font-semibold border-r border-slate-600 sticky left-0 bg-slate-700 z-10 min-w-25 sm:min-w-37.5 print:static">
                        Dump Truck
                      </th>
                              ...
                              {trips.length > 0 ? (
                                <div className="space-y-1">
                                  {trips.map((trip, tripIdx) => (
                                    <div
                                      key={tripIdx}
                                      className="relative group text-xs bg-slate-700 rounded px-1 sm:px-2 py-1 print:bg-gray-100 print:border print:border-gray-300"
                                    >
                                        ...
                                        <DropdownMenu>
                                          <DropdownMenuTrigger asChild>
                                            <Button
                                              variant="ghost"
                                              size="icon"
                                              className="h-5 w-5 bg-slate-600 hover:bg-slate-500 rounded-full"
                                            >
                                              <MoreVertical className="h-3 w-3" />
                                            </Button>
                                          </DropdownMenuTrigger>
                                          <DropdownMenuContent align="end" className="w-32 dark:bg-slate-900 dark:text-neutral-50 border-none">
                                            <DropdownMenuItem
                                            ...
                                            <DropdownMenuItem
                                              ...
                                              className="cursor-pointer text-red-600 focus:text-red-600 dark:hover:bg-red-800 dark:hover:text-neutral-50"
                                            >
