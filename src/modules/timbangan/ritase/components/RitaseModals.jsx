...
export const InputFormModal = ({
  ...
  return (
    <div className="detail-modal fixed inset-0 bg-black/50 dark:bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4 transition-all">
      <div className="bg-neutral-50 dark:bg-gray-900 rounded-lg max-w-4xl w-full max-h-[90vh] overflow-auto scrollbar-thin shadow-2xl dark:shadow-gray-900/50 border border-gray-200 dark:border-gray-700">
