...
const MasterDataModal = ({
  ...
  return (
    ...
    >
      <Card
        className="w-full sm:max-w-md md:max-w-lg rounded-t-2xl sm:rounded-2xl max-h-[92vh] overflow-y-auto scrollbar-thin bg-neutral-50   dark:bg-gray-900 border-none"
