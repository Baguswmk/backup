    ...
    const validateFleet2 = useCallback(() => {
      ...
      if (companies.size > 1) {
        if (!fleet2InspectorIds || fleet2InspectorIds.length === 0) {
          e.fleet2Inspector = "Pilih minimal 1 inspector untuk Fleet 2 (ada lebih dari 1 company)";
        }
      }
      ...
      fleet2SelectedUnits.forEach((unit) => {
        if (!fleet2UnitOperators[unit.id]) {
          ...
          e.fleet2Operators = "Semua dump truck di Fleet 2 harus memiliki operator";
        }
      });
                ...
                <Checkbox
                  ...
                  onCheckedChange={(checked) => {
                    ...
                    if (!checked) {
                      ...
                      // Bug Fix 3: Auto-populate inspector dan checker dari Fleet 1
                      // ketika split mode diaktifkan
                  ...
                  <div className="p-4 space-y-4">
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400">
                          💡 Checker otomatis sama dengan Fleet 1 (bisa diubah
                          jika perlu berbeda)
                        </p>
                      </div>
                    </div>
                    ...
                    {(() => {
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400">
                          💡 Inspector otomatis sama dengan Fleet 1 (bisa diubah
                          jika perlu berbeda)
                        </p>
                      </div>
                    )}
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <Button
                                ...
                                onClick={() => {
                                  ...
                                  // Bug Fix 2: Pindahkan operator dari Fleet 1 ke Fleet 2
                                  const operatorsToTransfer = {};
                                  unitsToTransfer.forEach((unit) => {
                                    if (unitOperators[unit.id]) {
                                      operatorsToTransfer[unit.id] =
                                        unitOperators[unit.id];
                                    }
                                  });
