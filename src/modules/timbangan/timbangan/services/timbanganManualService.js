...
export const timbanganManualService = {
  ...
  async submitForm(formData) {
    try {
      ...
      // Gunakan endpoint yang sama, backend membedakan dari measurement_type
  ...
  async editForm(formData, editId) {
    try {
      ...
      const result = {
        ...
        loading_location: response.data?.attributes?.loading_location || payload.loading_location,
        dumping_location: response.data?.attributes?.dumping_location || payload.dumping_location,
        ...
        pic_work_unit: response.data?.attributes?.pic_work_unit || payload.pic_work_unit,
        operator: response.data?.attributes?.operator || payload.operator || null,
