          ...
          <div className="bg-gray-100 dark:bg-gray-800 px-4 py-3 flex items-center justify-between hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors cursor-pointer">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="text-right">
                ...
                <div
                  className={`font-bold ${isBelowTarget ? "text-red-600 dark:text-red-400" : "text-green-600 dark:text-green-400"}`}
                >
                          ...
                          return (
                            ...
                            >
                              ...
                              <td className="px-3 py-2">
                                <Badge
                                  variant="secondary"
                                  className="dark:bg-gray-700 text-xs"
                                >
                                  {kendala.shift}
                                </Badge>
                              </td>
                              ...
                              <td className="px-3 py-2 text-center">
                                <DropdownMenu
                                  ...
                                  onOpenChange={(open) =>
                                    setKendalaActionMenuOpen(
                                      open ? kendala.id : null,
                                    )
                                  }
                                >
                                  ...
                                  <DropdownMenuContent
                                    align="end"
                                    className="w-40 dark:bg-slate-800 border-none"
                                  >
                                    <DropdownMenuItem
                    ...
                    >
                      ...
                      <td className="px-3 py-2 text-center relative">
                        <Button
                          ...
                          onClick={() =>
                            setActionMenuOpen(
                              actionMenuOpen === ritase.id ? null : ritase.id,
                            )
                          }
